    ...
    function CalenderWrapper(props) {
        ...
        if (props.multiple) {
          ...
          if (value && value.length) {
            formattedValue = value.map(function (singleValue) {
              return (0, _utils.formatDate)(singleValue, props.format);
            }).join(', ');
          }
      ...
      _this.renderPicker = function (_ref) {
        ...
        var calendar = /*#__PURE__*/React.createElement(TheCalendar, _extends({}, calendarProps, {
          ...
          defaultValue: props.defaultPickerValue || (multiple ? [(0, _interopDefault["default"])(moment)()] : (0, _interopDefault["default"])(moment)()),
        ...
        }, props.clearIcon) : /*#__PURE__*/React.createElement(_icon["default"], {
          type: "close-circle",
        ...
        }, suffixIcon)) || props.pickerIcon || /*#__PURE__*/React.createElement(_icon["default"], {
          type: "calendar",
          className: "".concat(prefixCls, "-picker-icon")
        });
        var inputValue = '';
        ...
        if (value) {
          if (props.formatInput) {
            ...
            if (multiple && 'map' in value) {
              ...
              inputValue = (0, _utils.formatDate)(value, props.format);
            }
          }
        }
