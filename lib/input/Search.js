...
var Search = /*#__PURE__*/function (_React$Component) {
  ...
  function Search() {
    ...
    _this.renderSuffix = function (prefixCls) {
      ...
      var node = /*#__PURE__*/React.createElement(_icon["default"], {
        className: "".concat(prefixCls, "-icon"),
        type: "search",
        key: "searchIcon",
      ...
      if (suffix) {
        ...
        if ( /*#__PURE__*/React.isValidElement(cloneSuffix) && !cloneSuffix.key) {
          cloneSuffix = /*#__PURE__*/React.cloneElement(cloneSuffix, {
            key: 'originSuffix'
          });
        }
